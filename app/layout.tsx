...
const SITE_TITLE = "조천읍 도의원 당선인 김덕홍 — 말보다 실천, 조천을 바꾸겠습니다";
const SITE_DESCRIPTION =
  "38년 공직 경험, 현장에서 배운 행정으로 조천읍을 확 바꾸겠습니다. 조천읍 도의원 당선인 김덕홍(무소속).";
...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    types: {
      "application/rss+xml": [
        { url: "/feed.xml", title: "조천읍 도의원 당선인 김덕홍 — 소식" },
      ],
    },
  },
  verification: {
