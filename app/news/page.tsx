...
export async function generateMetadata({
  ...
  const title =
    page > 1
      ? `보도자료 (${page}페이지) — 조천읍 도의원 당선인 김덕홍`
      : "보도자료 — 조천읍 도의원 당선인 김덕홍";
  const description = `조천읍 도의원 당선인 김덕홍(무소속) 관련 언론보도 및 캠페인 소식 — 총 ${total}건`;
